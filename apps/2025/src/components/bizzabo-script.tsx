...
export function BizzaboScript() {
  useEffect(() => {
    ...
    script.id = 'bz-popup-registration-script-ae887e03-ee3b-4c94-be05-54d63f30b781'
    ...
    bizzaboScript.setAttribute('data-flow-id', 'ae887e03-ee3b-4c94-be05-54d63f30b781')
    bizzaboScript.setAttribute('data-inline-widget', 'true')
    bizzaboScript.src = 'https://organizer.bizzabo.com/widgets/flows/popup/registrationPopup.js'
